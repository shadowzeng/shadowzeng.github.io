...
function buildPath(ctx, shape) {debugger
    var x = shape.x;
    var y = shape.y;
...
PathProxy.prototype = {
     ...
     * @param {CanvasRenderingContext2D} ctx
     */
    rebuildPath: function (ctx) {debugger
        var d = this.data;
        var x0, y0;
        var xi, yi;
        var x, y;
...
var Arc = Path.extend({
    ...
    buildPath: function (ctx, shape) {debugger
...
var Circle = Path.extend({
    ...
    buildPath : function (ctx, shape, inBundle) {debugger
